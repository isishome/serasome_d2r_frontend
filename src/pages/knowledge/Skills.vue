...
const Tree = defineAsyncComponent(() => import('@/components/knowledge/Tree.vue'))
const Skill = defineAsyncComponent(() => import('@/components/knowledge/Skill.vue'))
